...
Constants and parsers live in `@backstage-community/plugin-grpc-docs-common` (`GRPC_DOCS_ENVIRONMENTS_ANNOTATION`, `GRPC_DOCS_OPERATIONS_ANNOTATION`, `parseEnvironments`, `parseOperations`).
